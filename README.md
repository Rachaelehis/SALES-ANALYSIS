...
- **data/**: Contains raw data files, including the main customer dataset.
- **notebooks/**: Jupyter notebooks for exploratory data analysis (EDA) and preliminary insights.
...
- **dashboard/**: Power BI dashboard file and supporting assets.
